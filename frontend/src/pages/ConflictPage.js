...
export function ConflictPage() {
    ...
    return (_jsx(Layout, { current: "conflict", children: _jsxs("section", { className: "card p-6", children: [_jsx("h2", { className: "text-lg font-semibold", children: "6. \u53E3\u5F84\u786E\u8BA4" }), _jsx("p", { className: "mt-1 text-sm text-slate-500", children: "AI \u4EC5\u62A5\u544A\u51B2\u7A81 + \u8BC1\u636E\uFF0C\u4E0D\u81EA\u52A8\u88C1\u51B3\uFF1B\u9700\u7531\u5206\u6790\u5E08\u6216\u6570\u5F00\u4EBA\u5DE5\u786E\u8BA4\u3002" }), _jsxs("div", { className: "mt-4 grid grid-cols-3 gap-3 text-sm", children: [_jsx(Stat, { label: "\u51B2\u7A81\u603B\u6570", value: data.conflict_count }), _jsx(Stat, { label: "\u9AD8\u98CE\u9669", value: data.high_count, accent: data.high_count > 0 ? "red" : "slate" }), _jsx(Stat, { label: "\u4E2D\u98CE\u9669", value: data.medium_count, accent: data.medium_count > 0 ? "amber" : "slate" })] }), data.conflicts.length === 0 ? (_jsx("div", { className: "mt-5 rounded-md bg-emerald-50 p-4 text-sm text-emerald-700", children: "\u672A\u53D1\u73B0\u51B2\u7A81\uFF0C\u53EF\u7EE7\u7EED dbt \u4EE3\u7801\u751F\u6210\u3002" })) : (_jsx("ul", { className: "mt-5 space-y-3", children: data.conflicts.map((c, i) => (_jsxs("li", { className: "rounded-md border border-slate-200 p-4", children: [_jsx("div", { className: "flex items-start justify-between", children: _jsxs("div", { children: [_jsxs("div", { className: "flex items-center gap-2", children: [_jsx("span", { className: `tag ring-1 ${LEVEL_COLORS[c.level]}`, children: c.level.toUpperCase() }), _jsx("span", { className: "text-sm font-medium", children: c.type })] }), _jsx("div", { className: "mt-2 text-sm text-slate-700", children: c.message }), _jsx("pre", { className: "mt-2 text-xs bg-slate-50 p-2 rounded overflow-auto", children: JSON.stringify(c.evidence, null, 2) })] }) }), _jsxs("div", { className: "mt-3 flex items-center gap-2 text-sm", children: [_jsx("span", { className: "text-slate-500", children: "\u4EBA\u5DE5\u88C1\u51B3\uFF1A" }), ["accept", "reject", "ignore"].map((opt) => (_jsxs("label", { className: "inline-flex items-center gap-1", children: [_jsx("input", { type: "radio", name: `d-${i}`, checked: decisions[c.asset] === opt, onChange: () => setDecisions({ ...decisions, [c.asset]: opt }) }), opt] }, opt)))] })] }, i))) })), _jsx("div", { className: "mt-6 flex items-center gap-3", children: _jsx("button", { className: "btn-primary", disabled: submitting || blocked, onClick: proceed, children: blocked ? "存在高风险冲突，请先逐项裁决" : "继续 dbt 代码生成" }) }), _jsx("p", { className: "mt-4 text-xs text-slate-400", children: data.compliance_note })] }) }));
}
